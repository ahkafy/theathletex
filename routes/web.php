...
Route::get('/register/{eventSlug}/one', [RegistrationController::class, 'otpForm'])->name('otp.form');
Route::get('/register/{eventSlug}/send', [RegistrationController::class, 'sendOTP'])->name('otp.send');
Route::post('/register/{eventSlug}/verify', [RegistrationController::class, 'verifyOTP'])->name('otp.verify');
Route::get('/register/{eventSlug}/two', [RegistrationController::class, 'registrationForm'])->name('register.create');
Route::post('/register/{eventSlug}/store', [RegistrationController::class, 'registerParticipant'])->name('register.store');
