    ...
    <div class="container">
        <div class="row g-md-5 g-2 px-3 px-md-0">
            ...
            <div class="col-md-3 mb-4">
                <img src="{{ url('images/logo-removebg-preview.png') }}" alt="TheAthleteX Logo" style="max-width: 150px;" class="mb-2">
                <p class="small">
                    TheAthleteX brings you closer to your favorite sports. Discover, register, and enjoy athletic events across Bangladesh.
                </p>
            </div>
