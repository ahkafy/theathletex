...
<head>
    ...
    <title>Upcoming Events - The Athlete X Limited</title>
...
<section class="hero-section bg-success text-white py-5">
    <div class="container text-center">
        ...
        <p class="lead">Get ready for exciting sports events coming your way</p>
    </div>
</section>
...
<main class="container my-5">
    ...
    <section class="my-5">
        <div class="d-flex align-items-center justify-content-between mb-4">
            <h2 class="fw-bold">Upcoming Events ({{ $events->count() }})</h2>
            ...
            @if($events->isEmpty())
                <div class="col-12">
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted">Stay tuned for exciting events coming soon.</p>
            ...
            @else
                @foreach ($events as $event)
                    <div class="col-12 col-md-6 col-lg-4 col-xl-3 mb-4">
                        <div class="card rounded-1 h-100 border-success">
                            <div class="badge bg-success position-absolute top-0 end-0 m-2 z-index-1">Upcoming</div>
                            ...
                            <div class="card-body p-0 d-flex flex-column">
                                @php
                                    ...
                                    $daysUntil = $startDate->diffInDays(now());
                                @endphp
                                <div class="px-3 pt-3">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <span class="badge bg-primary">{{ $daysUntil }} days to go</span>
                                ...
                                <p class="mb-1 px-3"><span class="fw-semibold">Start Time:</span> {{ $startDate->format('M d, Y - h:i A') }}</p>
                                @if($event->venue)
